...
public class TripController {
    ...
    @RequestMapping(value = "/{tId}/comment/{cId}/delete", method = RequestMethod.POST)
    public String deleteCommentFromTrip(@PathVariable("tId") Long tId, @PathVariable("cId") Long cId) {
        commentService.deleteCommentFromTrip(tripService.getTrip(tId), userService.getAuthenticatedUser(), commentService.getComment(cId));
        return "redirect:/trips/" + tId;
    }
}
